...
#     return TbAlunos.objects.filter(id=aluno_id).values().first()
...
#              )
# def criar_aluno(request, data: dict):
#     aluno = TbAlunos.objects.create(**data)
#     return TbAlunos.objects.filter(id=aluno.id).values().first()
...
#             )
# def atualizar_aluno(request, aluno_id: int, data: dict):
#     TbAlunos.objects.filter(id=aluno_id).update(**data)
#     return TbAlunos.objects.filter(id=aluno_id).values().first()
...
#     TbAlunos.objects.filter(id=aluno_id).delete()
